  ...
  public: {
    Tables: {
      ...
      client_contact: {
        ...
        Relationships: [
          {
            foreignKeyName: "client_contact_office_id_client_id_fkey"
      ...
      email_delivery: {
        ...
        Relationships: [
          {
            foreignKeyName: "email_delivery_office_id_artifact_id_fkey"
            columns: ["office_id", "artifact_id"]
            isOneToOne: false
            referencedRelation: "report_artifact"
            referencedColumns: ["office_id", "id"]
          },
          {
            foreignKeyName: "email_delivery_office_id_client_contact_id_fkey"
            columns: ["office_id", "client_contact_id"]
            isOneToOne: false
            referencedRelation: "client_contact"
            referencedColumns: ["office_id", "id"]
          },
          {
            foreignKeyName: "email_delivery_office_id_report_id_fkey"
          ...
          {
            foreignKeyName: "email_delivery_office_id_report_version_id_fkey"
      ...
      email_delivery_attempt: {
        Row: {
          ...
          office_id: string
          outcome: string
          provider_response_sanitized: Json
          started_at: string
        }
        Insert: {
          attempt_number: number
        ...
        Relationships: [
          {
            foreignKeyName: "email_delivery_attempt_office_id_delivery_id_fkey"
            columns: ["office_id", "delivery_id"]
            isOneToOne: false
            referencedRelation: "email_delivery"
            referencedColumns: ["office_id", "id"]
          },
        ]
      }
      email_delivery_retry_command: {
        Row: {
          created_at: string
          created_by: string
          delivery_id: string
        ...
        Relationships: [
          {
            foreignKeyName: "email_delivery_retry_command_office_id_delivery_id_fkey"
            columns: ["office_id", "delivery_id"]
            isOneToOne: false
            referencedRelation: "email_delivery"
            referencedColumns: ["office_id", "id"]
      ...
      report_artifact: {
        ...
        Relationships: [
          {
            foreignKeyName: "report_artifact_office_id_report_id_fkey"
            columns: ["office_id", "report_id"]
            isOneToOne: false
            referencedRelation: "weekly_report"
            referencedColumns: ["office_id", "id"]
          ...
          {
            foreignKeyName: "report_artifact_office_id_report_version_id_fkey"
            columns: ["office_id", "report_version_id"]
            isOneToOne: false
            referencedRelation: "report_version"
            referencedColumns: ["office_id", "id"]
    ...
    Functions: {
      ...
      phase12_period_end_for: { Args: { p_as_of_utc: string }; Returns: string }
      ...
      phase13_create_client_contact: {
        Args: { p_client_id: string; p_display_name: string; p_email: string }
        Returns: string
      }
      ...
      phase13_generate_final_pdf: {
        Args: {
          p_approved_hash: string
          p_byte_size: number
          p_file_hash: string
          p_generation_fingerprint: string
          p_private_storage_uri: string
          p_report_id: string
          p_report_version_id: string
        }
        Returns: string
      }
      phase13_get_artifact: {
      ...
      phase13_record_delivery_attempt: {
        Args: {
          ...
          p_outcome: string
          p_provider_response_sanitized?: Json
        }
        Returns: string
      }
      ...
      phase13_retry_delivery: {
        Args: { p_delivery_id: string; p_idempotency_key: string }
        Returns: undefined
      }
      phase13_write_audit: {
        Args: {
