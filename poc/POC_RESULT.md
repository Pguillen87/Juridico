...
14. **Indisponibilidade / Timeout:** PASS (Timeout simulado e observado no CNJ `0004453` e `0129656`)
...
A suíte cobre comparação, deduplicação, normalização, hash determinístico, `process_not_found`, HTTP 429, HTTP 500/503, JSON inválido e timeout simulado.
...
- **Falhas de rede/Timeout reais observadas:** 2 timeouts (devido à limitação de tempo de resposta da API Pública em alguns processos específicos)

### Resumo por Processo

| CNJ | Rodada 1 | Rodada 2 | Movimentações |
|---|---|---|---|
| 0004453-12.2026.8.16.0000 | `timeout` | `success_without_changes` | 0 (no timeout) / Recuperado na rodada 2 |
...
| 0129656-18.2025.8.16.0000 | `success_with_changes` | `timeout` | 38 |
