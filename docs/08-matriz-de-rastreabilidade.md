...
| O-004 | RF-012 | US-038 | `report_artifact` | PDF/Storage | 13 | T-038 PDF hash | `17_phase_13_pdf_delivery.test.sql`, `pdf-renderer.test.ts`: PDF `%PDF-`, SHA-256, snapshot, tamanho, bucket/URI privados e artefato somente após aprovação | IMPLEMENTADO/TESTADO — sandbox/local |
| O-004 | RF-012 | US-039 | `email_delivery` | Delivery | 13 | T-039 send | `17_phase_13_pdf_delivery.test.sql`, `email-provider.test.ts`: contato confirmado, autorização lawyer, idempotência, estados e resultado `unknown_outcome`; provider real não chamado | IMPLEMENTADO/TESTADO — sandbox/local; transporte real deferido |
| O-004 | RF-012 | US-040 | `email_delivery`, `report_artifact` | Delivery | 13 | T-040 immutable copy | Hash aprovado, hash do artefato, URI privada, tentativas append-only, retry/reconcile/resend e auditoria allowlisted | IMPLEMENTADO/TESTADO — sandbox/local |
