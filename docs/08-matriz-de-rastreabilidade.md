...
| O-005 | RF-013 | US-041 | `audit_log` | Audit | 3–14 | T-041 audit | RPCs F13 gravam eventos allowlisted na mesma transação; rollback de auditoria e imutabilidade cobertos por `17_phase_13_pdf_delivery.test.sql` | IMPLEMENTADO/TESTADO — sandbox/local; retenção/expurgo deferidos |
