...
| O-004 | RF-012 | US-038 | `report_artifact` | PDF/Storage | 13 | T-038 PDF hash | `17_phase_13_pdf_delivery.test.sql`, `pdf-renderer.test.ts`: PDF `%PDF-`, SHA-256, snapshot, tamanho, bucket/URI privados e artefato somente após aprovação | IMPLEMENTADO/TESTADO — local/sandbox |
| O-004 | RF-012 | US-039 | `email_delivery` | Delivery | 13 | T-039 send | `17_phase_13_pdf_delivery.test.sql`, `email-provider.test.ts`: contato confirmado, autorização lawyer, idempotência, estados e resultado `unknown_outcome`; provider real não chamado | IMPLEMENTADO/TESTADO — transporte real deferido |
| O-004 | RF-012 | US-040 | `email_delivery`, `report_artifact` | Delivery | 13 | T-040 immutable copy | Hash aprovado, hash do artefato, URI privada, tentativas append-only, retry/reconcile/resend e auditoria allowlisted | IMPLEMENTADO/TESTADO — storage remoto e e-mail real deferidos |
| O-005 | RF-013 | US-041 | `audit_log` | Audit | 3–14 | T-041 audit | RPCs F13 gravam eventos allowlisted na mesma transação; rollback de auditoria e imutabilidade cobertos por `17_phase_13_pdf_delivery.test.sql` | IMPLEMENTADO/TESTADO — retenção/expurgo deferidos |
